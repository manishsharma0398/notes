...
- `examples/` — runnable pipeline definitions with real run output pasted.
...
- `exercises/cumulative_exercise.md` — 1–3 hours, integrating everything so far. Prefer something
  that **doubles as a whiteboard question** at this level: a pipeline you build, break and gate — each phase adding one guarantee. Phased, with success
