# Cumulative Exercise — Chapters 1–13: `relay`, a Concurrency-Limited Task Runner
...
`Promise.race([])` waiting to happen (Chapter 13, Part 8).
...
thenable (Chapter 13, Part 4) is any object with a callable `then` — so you can return a plain
