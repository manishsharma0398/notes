# Chapter 13 — Interview Questions: Promises and Async
...
interviewer is scoring, and the follow-up they will ask next. The model answers are written to
be *spoken*, not read — say them out loud.
...
**Red flag:** saying `await` "blocks" or "pauses the thread". The function *returns*; the
