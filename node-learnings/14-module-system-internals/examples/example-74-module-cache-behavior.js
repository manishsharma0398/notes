...
console.log(
  `Heap after GC: ${(parseFloat(heapAfterGC.used) - parseFloat(heapBefore.used)).toFixed(2)} MB above initial`,
);
console.log(
  `Module still in cache: ${testModulePath in require.cache ? "Yes" : "No"}`,
);
console.log(
  `Cache still holds reference: ${require.cache[testModulePath] ? "Yes" : "No"}`,
);
...
console.log(
  `Test module in cache: ${testModulePath in require.cache ? "Yes" : "No"}`,
);
...
console.log(
  `Heap reduction: ${(parseFloat(heapAfterGC.used) - parseFloat(heapAfterClear.used)).toFixed(2)} MB`,
);
...
console.log(
  "3. Removing local references does not free memory (cache holds reference)",
);
