...
### Exercise 1: Version-Specific Behavior Testing

Create a test suite for version-dependent behavior:

- Write code that behaves differently in Node 16 vs 18 vs 20
- Test Promise microtask timing differences
- Test `fetch()` availability (Node 18+)
- Document observed differences
- Implement feature detection to work across versions
- Explain why version checking is fragile

**Interview question this tests**: "How do you write code that works across multiple Node.js versions?"

### Exercise 2: Platform Dependency Identification

Create a script that demonstrates platform-specific issues:

- Test file system case sensitivity (Windows vs Linux)
- Test timer precision differences (OS-dependent)
- Test path separator handling (`\\` vs `/`)
- Measure performance differences between platforms
- Implement cross-platform compatible code
- Explain common production gotchas

**Interview question this tests**: "What are the biggest platform-specific issues in Node.js and how do you handle them?"

### Exercise 3: Safe Upgrade Simulation

Simulate a Node.js version upgrade process:

- Start with Node 16 codebase using deprecated APIs
- Upgrade to Node 18 - identify breaking changes
- Run with `--pending-deprecation` flag
- Fix deprecation warnings
- Test with new Node 20 features
- Document migration process and lessons learned

**Interview question this tests**: "How do you safely upgrade a production Node.js application to a new major version?"
